  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-dark overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute top-40 right-20 w-24 h-24 bg-secondary/20 rounded-full blur-2xl floating-animation"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute bottom-40 left-1/4 w-40 h-40 bg-accent/10 rounded-full blur-3xl floating-animation"
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-8">
            <Badge
              variant="secondary"
              className="bg-primary/20 text-primary px-6 py-2 text-sm font-medium"
            >
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Современная платформа с AI-интеграцией для персонализированного
              обучения. Готовим к экзаменам с 8 по 11 класс
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            {stats.map((stat, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="glass-card border-white/10 stats-counter"
                >
